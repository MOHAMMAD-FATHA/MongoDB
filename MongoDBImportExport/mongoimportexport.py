...
* @Date: 2021-11-16 1:27
* @Last Modified by: Mohammad Fatha
* @Last Modified time: 2021-11-16 1:27 
* @Title: : Python program to import and export data from/to MongoDB using pymongo library
"""
...
class MongoDB():
    ...
    def export_data_to_db(self):
        ...
        try:
            ...
            df.to_csv("MongoDBImportExport/exportedcsv.csv")
...
if __name__ == "__main__":
    mongodb = MongoDB(dBName='StartupExpansion', collectionName='Expansion')
    mongodb.import_data_into_db(path='/home/fatha/Documents/MongoDB/MongoDBImportExport/P1-StartupExpansion.csv')
